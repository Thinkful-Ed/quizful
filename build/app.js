...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginPage = __webpack_require__(168);
	
	var _loginPage2 = _interopRequireDefault(_loginPage);
	
	var _question = __webpack_require__(170);
	...
	document.addEventListener('DOMContentLoaded', function () {
	    _reactDom2.default.render(_react2.default.createElement(_question2.default, null), document.querySelector('.app'));
	});
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "p",
	          null,
	          "Please use your Thinkful Login"
	        ),
	        _react2.default.createElement(
	          "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _answers = __webpack_require__(172);
	...
	var Question = function (_Component) {
	  ...
	  function Question(props) {
	    ...
	    _this.lastQuestion = _this.lastQuestion.bind(_this);
	    _this.resetQuiz = _this.resetQuiz.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Question, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.currentQ < this.state.questions.length) {
	        var _ret = function () {
	          var allAnswers = [];
	          _this2.state.questions[_this2.state.currentQ].possAnswers.forEach(function (item, i) {
	            allAnswers.push(_react2.default.createElement(_answers2.default, { key: i, answer: _this2.state.questions[_this2.state.currentQ].correctAnswer, name: item }));
	          });
	          return {
	            v: _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  null,
	                  'Question ',
	                  _this2.state.currentQ + 1,
	                  ' of ',
	                  _this2.state.questions.length
	                ),
	                _react2.default.createElement(
	                  'h1',
	                  null,
	                  _this2.state.questions[_this2.state.currentQ].question
	                ),
	                _react2.default.createElement(
	                  'ul',
	                  { className: 'answers' },
	                ...
	                _react2.default.createElement(
	                  'button',
	                  { className: 'prev-button', type: 'button', onClick: _this2.lastQuestion },
	                  'Previous Question'
	                ),
	                _react2.default.createElement(
	                  'button',
	                  { className: 'next-button', type: 'button', onClick: _this2.nextQuestion },
	                  'Next Question'
	                )
	              )
	            )
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'button',
	              { onClick: this.resetQuiz, type: 'button', className: 'next-button' },
	              'Restart'
	            )
	          )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Answer = function (_Component) {
	  ...
	  function Answer(props) {
	    ...
	    _this.qCheck = _this.qCheck.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Answer, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        { onClick: this.qCheck },
	        this.props.name,
	        _react2.default.createElement("i", { className: this.state.class, "aria-hidden": "true" })
	      );
	    }
	  }]);
